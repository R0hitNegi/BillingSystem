        ...
        <div class="row">
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal1">
              ...
              <img class="img-fluid" src="resources/img/portfolio/customs1.jpg" alt="">
            </a>
        ...
        <div class="row">
          <div class="col-sm-4">
            <div class="team-member">
              <img class="mx-auto rounded-circle" src="resources/img/login-face2.jpg" alt="">
              ...
              <ul class="list-inline social-buttons">
                ...
                <li class="list-inline-item">
                  <a href="www.linkedin.com/in/prashantmi/">
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <p class="item-intro text-muted">A Comrade For Customs Agents And Brokers.</p>
                  <img class="img-fluid d-block mx-auto" src="resources/img/portfolio/customs1.jpg" alt="">
                  <p>A Billing, Filing And Record Storing Software Service For Customs Clearence India An Aplication For Customs 
